...
# Step 1:创建训练集路径和测试集路径
    new_train_data_path = os.path.join(os.getcwd(), 'data/train_set')
    new_test_data_path = os.path.join(os.getcwd(), 'data/test_set')
...
#Step 2:将Cat和Dog类别中id>=10000的图片存到测试集路径中,其他图片存到训练集路径中
    origin_dataset_path = os.path.join(os.getcwd(), 'data/CatDog')
